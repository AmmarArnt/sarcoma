...
| **Clay-colloid analogy → "target the exchangeable maintenance layer, not the immovable driver"** (4 patient-anchored forward hypotheses FH-Clay-1…4: flood-the-ERV/dsRNA-program / valence-adhesion / pH-set-point / telomere-"kiln"; effectors mapped across bio·pharma·chem·natural) | `clay-colloid-forward-hypotheses.md` (analogy-derived team, 2026-06-16) | Theoretical (analogy-derived; zero CIC-DUX4-specific effector evidence) | **Low** | composite (info/diagnostics F1; HDACi/DNMTi F1; imetelstat F2/F3; most effectors future-line, myelosuppression-gated) | Supplies a physical rationale for the catalog's drainable-attractor finding; mostly **fusion-agnostic** (good for the ~5%); two red-teams flagged "direction beats potency" (dispersion + systemic-alkalinization wrong/unsafe here). **Not a fifth vector, not a new axis.** |
